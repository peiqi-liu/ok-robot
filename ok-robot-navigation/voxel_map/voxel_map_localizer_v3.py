...
class VoxelMapLocalizerV3():
    def __init__(self, semantic_memory, owl_vit_config = "google/owlv2-base-patch16-ensemble", device = 'cuda'):
        self.device = device
    ...
    def load_pretrained(self):
        ...
        model = Owlv2Model.from_pretrained(self.model_name).to(self.device)
